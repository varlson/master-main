...
from refat.bootstrap import LEGACY_PROJECT_ROOT, WORKSPACE_ROOT
from refat.datasets import SUPPORTED_BACKBONE_METHODS, SUPPORTED_BASE_DATASETS
from refat.model_registry import SUPPORTED_MODELS


SUPPORTED_MODES = ("search_best", "run_best", "search_and_run")
...
def load_config(config_file: str | Path) -> RefatConfig:
    ...
    return RefatConfig(
        ...
        original_data_dir=_resolve_path(
            ...
            base_dir=base_dir,
            default=LEGACY_PROJECT_ROOT / "data" / "npy",
        ),
        ...
        results_dir=_resolve_path(
            ...
            base_dir=base_dir,
            default=WORKSPACE_ROOT / "refat" / "results",
        ),
