...
OUTPUT_ROOT = SCRIPT_DIR / "analisys"
DEFAULT_DATASET_LIST = ["metr-la", "pems-bay"]
DEFAULT_METHODS = ["disp_fil", "nois_corr", "high_sal", "doub_stoch"]
DEFAULT_ALPHA = 0.1
...
try:  # noqa: E402
    ...
    def dataset_backbone_combinations(
        methods=["disp_fil", "nois_corr", "high_sal", "doub_stoch"],
        alpha=0.1,
        percentile=None,
    ):
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--methods",
        nargs="+",
        choices=["disp_fil", "nois_corr", "high_sal", "doub_stoch"],
