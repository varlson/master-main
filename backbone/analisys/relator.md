...
Nas colunas dos backbones, o valor entre parenteses indica o delta percentual em relacao a rede original.

| Metrica | Original | Noise Corrected | Disparity Filter |
| --- | ---: | ---: | ---: |
| Nos | 207 | 207 (Δ +0.00%) | 207 (Δ +0.00%) |
| Arestas | 1313 | 1022 (Δ -22.16%) | 364 (Δ -72.28%) |
| Densidade | 0.0616 | 0.0479 (Δ -22.16%) | 0.0171 (Δ -72.28%) |
| Grau medio | 12.69 | 9.87 (Δ -22.16%) | 3.52 (Δ -72.28%) |
| Forca media | 5.14 | 4.67 (Δ -9.17%) | 2.73 (Δ -46.98%) |
| Peso medio | 0.406 | 0.473 (Δ +16.70%) | 0.776 (Δ +91.27%) |
| Peso mediano | 0.321 | 0.421 (Δ +30.95%) | 0.778 (Δ +142.05%) |
| Clustering medio | 0.5485 | 0.4829 (Δ -11.97%) | 0.3913 (Δ -28.65%) |
| Eficiencia local | 0.7473 | 0.6985 (Δ -6.53%) | 0.4646 (Δ -37.82%) |
| Eficiencia global | 0.2789 | 0.2545 (Δ -8.73%) | 0.1072 (Δ -61.57%) |
| Componentes | 2 | 2 (Δ +0.00%) | 17 (Δ +750.00%) |
| Razao GCC | 0.9952 | 0.9952 (Δ +0.00%) | 0.8454 (Δ -15.05%) |
| Caminho medio GCC | 5.0637 | 5.5292 (Δ +9.19%) | 10.7903 (Δ +113.09%) |
| Diametro GCC | 13.0 | 14.0 (Δ +7.69%) | 28.0 (Δ +115.38%) |
| Assortatividade | 0.4616 | 0.2622 (Δ -43.20%) | 0.4800 (Δ +3.97%) |
| Comunidades | 8 | 8 (Δ +0.00%) | 28 (Δ +250.00%) |
| Modularidade | 0.6978 | 0.7094 (Δ +1.66%) | 0.8314 (Δ +19.15%) |
| Maior comunidade | 53 | 53 (Δ +0.00%) | 24 (Δ -54.72%) |
...
\begin{table}[ht]
\centering
\caption{metr-la: indices estruturais originais e apos extracao de backbone (alpha=0.3), com delta percentual em relacao a rede original.}
\label{tab:metr_la_indices}
\begin{tabular}{lrrr}
\toprule
Metrica & Original & Noise Corrected & Disparity Filter \\
\midrule
Nos & 207 & 207 ($\Delta$ +0.00\%) & 207 ($\Delta$ +0.00\%) \\
Arestas & 1313 & 1022 ($\Delta$ -22.16\%) & 364 ($\Delta$ -72.28\%) \\
Densidade & 0.0616 & 0.0479 ($\Delta$ -22.16\%) & 0.0171 ($\Delta$ -72.28\%) \\
Grau medio & 12.69 & 9.87 ($\Delta$ -22.16\%) & 3.52 ($\Delta$ -72.28\%) \\
Forca media & 5.14 & 4.67 ($\Delta$ -9.17\%) & 2.73 ($\Delta$ -46.98\%) \\
Peso medio & 0.406 & 0.473 ($\Delta$ +16.70\%) & 0.776 ($\Delta$ +91.27\%) \\
Peso mediano & 0.321 & 0.421 ($\Delta$ +30.95\%) & 0.778 ($\Delta$ +142.05\%) \\
Clustering medio & 0.5485 & 0.4829 ($\Delta$ -11.97\%) & 0.3913 ($\Delta$ -28.65\%) \\
Eficiencia local & 0.7473 & 0.6985 ($\Delta$ -6.53\%) & 0.4646 ($\Delta$ -37.82\%) \\
Eficiencia global & 0.2789 & 0.2545 ($\Delta$ -8.73\%) & 0.1072 ($\Delta$ -61.57\%) \\
Componentes & 2 & 2 ($\Delta$ +0.00\%) & 17 ($\Delta$ +750.00\%) \\
Razao GCC & 0.9952 & 0.9952 ($\Delta$ +0.00\%) & 0.8454 ($\Delta$ -15.05\%) \\
Caminho medio GCC & 5.0637 & 5.5292 ($\Delta$ +9.19\%) & 10.7903 ($\Delta$ +113.09\%) \\
Diametro GCC & 13.0 & 14.0 ($\Delta$ +7.69\%) & 28.0 ($\Delta$ +115.38\%) \\
Assortatividade & 0.4616 & 0.2622 ($\Delta$ -43.20\%) & 0.4800 ($\Delta$ +3.97\%) \\
Comunidades & 8 & 8 ($\Delta$ +0.00\%) & 28 ($\Delta$ +250.00\%) \\
Modularidade & 0.6978 & 0.7094 ($\Delta$ +1.66\%) & 0.8314 ($\Delta$ +19.15\%) \\
Maior comunidade & 53 & 53 ($\Delta$ +0.00\%) & 24 ($\Delta$ -54.72\%) \\
\bottomrule
\end{tabular}
\end{table}
```
...
| Metrica | Original | Noise Corrected | Disparity Filter |
| --- | ---: | ---: | ---: |
| Nos | 325 | 325 (Δ +0.00%) | 325 (Δ +0.00%) |
| Arestas | 2079 | 1772 (Δ -14.77%) | 695 (Δ -66.57%) |
| Densidade | 0.0395 | 0.0337 (Δ -14.77%) | 0.0132 (Δ -66.57%) |
| Grau medio | 12.79 | 10.90 (Δ -14.77%) | 4.28 (Δ -66.57%) |
| Forca media | 6.78 | 6.35 (Δ -6.38%) | 3.77 (Δ -44.35%) |
| Peso medio | 0.530 | 0.582 (Δ +9.84%) | 0.883 (Δ +66.47%) |
| Peso mediano | 0.509 | 0.588 (Δ +15.67%) | 0.905 (Δ +78.00%) |
| Clustering medio | 0.6737 | 0.6589 (Δ -2.20%) | 0.6035 (Δ -10.42%) |
| Eficiencia local | 0.8130 | 0.8024 (Δ -1.30%) | 0.6939 (Δ -14.64%) |
| Eficiencia global | 0.2423 | 0.2233 (Δ -7.87%) | 0.0379 (Δ -84.38%) |
| Componentes | 7 | 7 (Δ +0.00%) | 32 (Δ +357.14%) |
| Razao GCC | 0.9815 | 0.9815 (Δ +0.00%) | 0.3323 (Δ -66.14%) |
| Caminho medio GCC | 5.1616 | 5.6190 (Δ +8.86%) | 8.0817 (Δ +56.57%) |
| Diametro GCC | 13.0 | 13.0 (Δ +0.00%) | 23.0 (Δ +76.92%) |
| Assortatividade | 0.5696 | 0.4748 (Δ -16.63%) | 0.7561 (Δ +32.74%) |
| Comunidades | 19 | 20 (Δ +5.26%) | 42 (Δ +121.05%) |
| Modularidade | 0.8198 | 0.8425 (Δ +2.76%) | 0.9061 (Δ +10.52%) |
| Maior comunidade | 67 | 53 (Δ -20.90%) | 35 (Δ -47.76%) |
...
\begin{table}[ht]
\centering
\caption{pems-bay: indices estruturais originais e apos extracao de backbone (alpha=0.3), com delta percentual em relacao a rede original.}
\label{tab:pems_bay_indices}
\begin{tabular}{lrrr}
\toprule
Metrica & Original & Noise Corrected & Disparity Filter \\
\midrule
Nos & 325 & 325 ($\Delta$ +0.00\%) & 325 ($\Delta$ +0.00\%) \\
Arestas & 2079 & 1772 ($\Delta$ -14.77\%) & 695 ($\Delta$ -66.57\%) \\
Densidade & 0.0395 & 0.0337 ($\Delta$ -14.77\%) & 0.0132 ($\Delta$ -66.57\%) \\
Grau medio & 12.79 & 10.90 ($\Delta$ -14.77\%) & 4.28 ($\Delta$ -66.57\%) \\
Forca media & 6.78 & 6.35 ($\Delta$ -6.38\%) & 3.77 ($\Delta$ -44.35\%) \\
Peso medio & 0.530 & 0.582 ($\Delta$ +9.84\%) & 0.883 ($\Delta$ +66.47\%) \\
Peso mediano & 0.509 & 0.588 ($\Delta$ +15.67\%) & 0.905 ($\Delta$ +78.00\%) \\
Clustering medio & 0.6737 & 0.6589 ($\Delta$ -2.20\%) & 0.6035 ($\Delta$ -10.42\%) \\
Eficiencia local & 0.8130 & 0.8024 ($\Delta$ -1.30\%) & 0.6939 ($\Delta$ -14.64\%) \\
Eficiencia global & 0.2423 & 0.2233 ($\Delta$ -7.87\%) & 0.0379 ($\Delta$ -84.38\%) \\
Componentes & 7 & 7 ($\Delta$ +0.00\%) & 32 ($\Delta$ +357.14\%) \\
Razao GCC & 0.9815 & 0.9815 ($\Delta$ +0.00\%) & 0.3323 ($\Delta$ -66.14\%) \\
Caminho medio GCC & 5.1616 & 5.6190 ($\Delta$ +8.86\%) & 8.0817 ($\Delta$ +56.57\%) \\
Diametro GCC & 13.0 & 13.0 ($\Delta$ +0.00\%) & 23.0 ($\Delta$ +76.92\%) \\
Assortatividade & 0.5696 & 0.4748 ($\Delta$ -16.63\%) & 0.7561 ($\Delta$ +32.74\%) \\
Comunidades & 19 & 20 ($\Delta$ +5.26\%) & 42 ($\Delta$ +121.05\%) \\
Modularidade & 0.8198 & 0.8425 ($\Delta$ +2.76\%) & 0.9061 ($\Delta$ +10.52\%) \\
Maior comunidade & 67 & 53 ($\Delta$ -20.90\%) & 35 ($\Delta$ -47.76\%) \\
\bottomrule
\end{tabular}
\end{table}
```
